...
<head>
    ...
    <title>Final Data 확인 Page</title>
    <style>
...
<body>
    ...
    <p>now time : <%=java.util.Calendar.getInstance().getTime() %></p>
        ...
        %>
    <table>
        <tr><th>Date</th><th>Temperature</th><th>Humidity</th><th>ButtonState</th></tr>
        <%
            String SQL = "SELECT * FROM Mix ORDER BY Date DESC limit 5";
            try {
